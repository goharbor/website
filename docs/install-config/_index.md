...
After installation, log into your Harbor via the web console to configure the instance under 'configuration'. Harbor also provides a command line interface (CLI) that allows you to [Configure Harbor System Settings at the Command Line](configure-system-settings-cli.md). Refer to [Install the Harbor CLI](harbor-cli.md) for CLI installation details.
